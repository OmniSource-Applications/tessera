...
/**
 * REST API for layer group operations.
 * Used by the admin UI (AJAX) and the map client for feature queries.
 */
@Slf4j
@RestController
...
public class LayerGroupApiController {
    ...
    public ResponseEntity<List<Map<String, Object>>> list() {
        List<Map<String, Object>> summaries = layerGroupService.listGroups().stream()
                .map(this::toSummary)
                .toList();
    ...
    /**
     * Add a member layer to a group.
     * Body: { "workspace": "...", "datastore": "...", "layer": "..." }
     */
    ...
    /**
     * Remove a member layer from a group.
     * Body: { "workspace": "...", "datastore": "...", "layer": "..." }
     */
    ...
    public ResponseEntity<LayerGroupRecord> removeMember(
            @PathVariable String name,
            @RequestBody Map<String, String> body) {
        return ResponseEntity.ok(layerGroupService.removeMember(
                name,
                body.get("workspace"),
                body.get("datastore"),
                body.get("layer")));
     ...
     * Body: { "minLon": ..., "minLat": ..., "maxLon": ..., "maxLat": ...,
     *         "limit": 1000, "offset": 0 }
     */
    ...
    public ResponseEntity<Map<String, Object>> queryFeatures(
        ...
        try {
            var rows = layerGroupService.queryFeaturesByBbox(
