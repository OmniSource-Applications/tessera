...
/**
 * A member of a layer group — references a layer by its workspace/datastore/layer path and caches
 * the resolved source_id + source_table for efficient geo_features queries.
 *
...
public record LayerGroupMember(
    String workspace, String datastore, String layer, String sourceId, String sourceTable) {
