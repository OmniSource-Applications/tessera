...
public record ApplicationProperties(
  ...
  public record CatalogProperties(@DefaultValue("300") int cacheTtlSeconds) {}

  public record CryptoProperties(String salt) {}

  public record ConnectorsProperties(CassandraProperties cassandra) {
    public record CassandraProperties(
        @DefaultValue("10") int sessionsMax, @DefaultValue("30") int expirationMinutes) {}
  }
}
