...
public class SecurityConfig {
  ...
  /**
   * Creates and configures an in-memory {@code UserDetailsService} for the "dev" profile. The
   * service includes a single user with the username "admin", password "admin", and roles "USER"
   * and "ADMIN".
   *
  ...
  public UserDetailsService userDetailsService() {
    UserDetails user =
        User.withUsername("admin")
            ...
            // Permissions -> direct authorities (used by @PreAuthorize and Thymeleaf
            // sec:authorize).
            .authorities(
                "TESSERA_OPS_VIEW", "TESSERA_OPS_ADMIN", "TESSERA_RBAC_VIEW", "TESSERA_RBAC_EDIT")
            .build();
