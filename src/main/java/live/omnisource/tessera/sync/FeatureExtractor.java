 ...
 *
 * <p>Knows how to find the geometry in different source types: - JDBC (PostGIS/MySQL/Oracle):
 * single geometry column name - Cassandra: comma-separated lat,lng column pair
 *
 * <p>Builds a stable external ID from one or more PK columns, falling back to a hash of all fields
 * if no PK is available.
 */
@Slf4j
public class FeatureExtractor {
  ...
  /**
   * Extract a feature from a raw record. Returns null if the geometry is missing or unparseable.
   */
