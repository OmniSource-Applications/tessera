...
/**
 * Utility class for encoding byte arrays into their hexadecimal string representation. The class is
 * designed to be used for converting raw byte data into a human-readable hexadecimal format,
 * commonly used in cryptographic operations and data encoding. This class is non-instantiable and
