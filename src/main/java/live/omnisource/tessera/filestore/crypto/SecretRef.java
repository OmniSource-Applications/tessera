...
/**
 * Represents a reference to a secret, encapsulating a key with a predefined URI scheme. This class
 * is immutable and provides utility methods for creating and parsing secret references.
 *
 * <p>The reference is always prefixed with the {@code secret://} scheme, which is validated during
